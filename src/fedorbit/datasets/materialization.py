...
WEAK_SIGNAL_SUBSAMPLE_DIGEST_DOMAIN = "FedORBIT|weak-signal-support-subsample"
...
def deterministic_smallest_hash_subsample_indices(
    ...
    for row_index in class_row_indices:
        payload = f"{WEAK_SIGNAL_SUBSAMPLE_DIGEST_DOMAIN}|{seed}|{coordinates_text}|{row_index}"
