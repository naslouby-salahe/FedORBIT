...
class Tensor:
    ...
    def add_(self, other: float | Tensor) -> Tensor: ...
...
def flip(input: Tensor, dims: tuple[int, ...] | list[int]) -> Tensor: ...
def randn(*size: int, generator: Generator | None = None) -> Tensor: ...
...
def where(
    condition: Tensor, x: Tensor, y: Tensor
) -> Tensor: ...
